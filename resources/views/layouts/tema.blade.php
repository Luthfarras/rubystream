        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Ruby Streaming Films <i class="fa fa-heart" aria-hidden="true"></i> by <a href="x" target="_blank">Colorlib</a>
